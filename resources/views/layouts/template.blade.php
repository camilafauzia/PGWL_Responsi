...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><i class="fa-solid fa-hotel"></i>Sleman Auberges</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <!-- <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('table-polyline') }}"><i class="fa-solid fa-table"></i> Table
                                    Polyline</a></li>
                            <li><a class="dropdown-item" href="{{ route('polygons') }}"><i class="fa-solid fa-table"></i> Table
                                    Polygon</a></li>
                            <li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route ('table-point') }}"><i class="fa-solid fa-table"></i> Table Attribute</a>
                    </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Website ini memberikan informasi yang terperinci mengenai berbagai hotel yang ada di Kabupaten Sleman, Yogyakarta. Informasi yang disediakan dapat mencakup daftar hotel-hotel beserta lokasi masing-masing hotel serta fasilitas yang tersedia di setiap hotel. Selain itu, website ini juga menyediakan peta interaktif yang mempermudah pengguna untuk melihat persebaran hotel di seluruh Kabupaten Sleman.                    Tujuan dari website ini adalah untuk membantu pengguna dalam memilih dan merencanakan penginapan mereka di Kabupaten Sleman dengan memberikan informasi yang akurat dan terkini mengenai berbagai pilihan hotel yang tersedia.
                </div>
